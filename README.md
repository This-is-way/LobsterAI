# Johnson-Claw — All-in-One Personal Assistant Agent

<p align="center">
  <img src="public/logo.png" alt="Johnson-Claw" width="120">
</p>

<p align="center">
  <strong>A 24/7 personal assistant Agent that gets things done, built by Johnson-WEB&APP</strong>
</p>
...
**Johnson-Claw** is an all-in-one personal assistant Agent developed by Johnson-WEB&APP. It works around the clock to handle your everyday tasks — data analysis, making presentations, generating videos, writing documents, searching the web, sending emails, scheduling tasks, and more.
...
git clone https://github.com/netease-youdao/Johnson-Claw.git
cd lobsterai
...
The bundled runtime is interpreter-focused and does not preinstall Johnson-Claw skill Python packages; those can be installed at runtime on demand.
...
Johnson-Claw uses Electron's strict process isolation. All cross-process communication goes through IPC.
...
Cowork is the core feature of Johnson-Claw — an AI working session system built on the Claude Agent SDK. Designed for productivity scenarios, it can autonomously complete complex tasks like data analysis, document generation, and information retrieval.
...
Johnson-Claw ships with 16 built-in skills covering productivity, creative, and automation scenarios, configured via `SKILLs/skills.config.json`:
...
Johnson-Claw supports scheduled tasks that let the Agent automatically execute recurring work on a set schedule.
...
Johnson-Claw can bridge the Agent to multiple IM platforms. Send a message from your phone via IM to remotely trigger the desktop Agent — command your personal assistant anytime, anywhere.
...
Johnson-Claw has a built-in memory system that remembers your personal information and preferences across sessions, making the Agent more helpful the more you use it.
...
- **Explicit Requests** — Tell the Agent directly, e.g., "remember that I prefer Markdown format" or "note down that my project is called Johnson-Claw," and it will store the memory with higher confidence
...
Johnson-Claw enforces security at multiple layers:
...
[![Star History Chart](https://api.star-history.com/svg?repos=netease-youdao/Johnson-Claw&type=date&legend=top-left)](https://www.star-history.com/#netease-youdao/Johnson-Claw&type=date&legend=top-left)
